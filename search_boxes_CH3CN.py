...
class StructureSearcher:
    ...
    def save_results(self) -> None:
        ...
        # Save structures
        self.universe.atoms.write(f"{self.output_dir}/CH3CN.gro")
        best_result.modified_universe.atoms.write(f"{self.output_dir}/CH3CN_best_init.gro")
        ...
        update_metadata(self.output_dir, {
            ...
            "search_info": {
                ...
                "worst_result": {
                    "file_name": "CH3CN_worst_init.gro",
